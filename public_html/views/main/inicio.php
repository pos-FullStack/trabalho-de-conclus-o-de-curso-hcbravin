            ...
            <div class="col-md-8 mx-auto">
                <div class="card text-bg-primary shadow">
                    <div class="card-body">
                        ...
                        <h2 class="fw-bold">R$ 12.567,89</h2>
                        <div class="d-flex justify-content-between mt-3">
                            <small>Conta: 12345-6</small>
                            <small>Agência: 0001</small>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                ...
                <div class="row justify-content-center overflow-auto pb-2">
                    <div class="col-4 col-sm-3 col-md-1 mb-2">
                        <a href="/transferir" class="btn btn-outline-primary w-100">
                    ...
                    <div class="col-4 col-sm-3 col-md-1 mb-2">
                        <a href="/pagar" class="btn btn-outline-primary w-100">
                    ...
                    <div class="col-4 col-sm-3 col-md-1 mb-2">
                        <a href="/pix" class="btn btn-outline-primary w-100">
                            <i class="fa fa-qrcode fs-4"></i>
                            <br>
                            <small>Área Pix</small>
                        </a>
                    </div>
                    <div class="col-4 col-sm-3 col-md-1 mb-2">
                        <a href="/cartoes" class="btn btn-outline-primary w-100">
                    ...
                    <div class="col-4 col-sm-3 col-md-1 mb-2">
                        <a href="/investimento" class="btn btn-outline-primary w-100">
                    ...
                    <div class="col-4 col-sm-3 col-md-1 mb-2">
                        <a href="/extrato" class="btn btn-outline-primary w-100">
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5>Meus cartões</h5>
                    <div>
                        <a href="/cartoes/novo" class="btn btn-warning btn-sm <?=(count($Cartoes) >= 2)?'d-none disabled':'';?>"><i class="fa fa-credit-card me-1"></i> Solicitar Cartão</a>
                        <a href="/cartoes" class="btn btn-sm btn-outline-primary"><i class="fa fa-credit-card me-1"></i> Ver todos</a>
                    </div>
                </div>
                <div class="row">
